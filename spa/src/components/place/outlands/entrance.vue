 ...
 *   - free play is restored: the weapons, the ammunition, the beam-out and the
 *     respawn are the world Script's own and they run;
 *   - the beam-out warning about changing avatar describes a historical rule
 *     that is NOT enforced. Scheduled matches, the Game Master and the turret
 *     cannons described further down are deferred lanes and do not work yet;
